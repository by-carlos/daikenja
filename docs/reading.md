...
- § Step A0: did the user name a project? -- project-decisions "Step 0: read the contracts"
- § Step A: resolve the config -- preflight "Step 3: cycle 0 -- the substance checks", project-decisions "Step 0: read the contracts"
- § Step B: resolve the ledger path -- preflight "Step 3: cycle 0 -- the substance checks", project-decisions "Step 0: read the contracts"
- § Step C: read and parse -- preflight "Step 3: cycle 0 -- the substance checks", project-decisions "Step 0: read the contracts"
- § Notices, shared wording -- project-decisions "Step 0: read the contracts"
