...
- § Reading a card -- project-summary "Step 0: read the contracts", thread "Step 2b: place the thread"
- § Resolving a project by content -- thread "Step 2b: place the thread"
