...
- 2026-08-13 -- D-004 -- @carlos -- Supersedes D-002. Roll the beacon service out region by region, not all at once -- a bad region can be paused without a global rollback.
- 2026-08-10 -- D-003 -- @priya -- Freeze schema changes on the events table from 2026-08-18 until the rollout completes.
  Two teams have pending migrations against that table. Both agreed to hold.
- 2026-07-20 -- D-002 -- @carlos -- Roll the beacon service out to every region at once. -> superseded by D-004
...
- [x] 2026-08-01 -- O-001 -- @sam -- Confirm the events table row counts with the data team. -> resolved 2026-08-05
