...
`~/.claude/daikenja/`, and `log` scaffolds the ledger into a project's
...
- [`ledger.md`](ledger.md) -- the empty ledger `log` scaffolds into a project's
  `.daikenja/`, with `{{PROJECT}}` replaced by the project name. Format:
