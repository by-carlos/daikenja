...
_PROJECT_MATCH = {
    ...
    DIGEST: (
        ...
        "no ledger on the strength of it, and put it under Unmatched, or "
        "under the configured digest group that claims it. Then name the "
        "near miss once, on the last line of Unmatched or at the very end "
        "when there is no Unmatched group, in this "
